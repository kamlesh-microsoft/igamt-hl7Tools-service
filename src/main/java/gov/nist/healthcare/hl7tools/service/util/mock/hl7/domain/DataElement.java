...
public class DataElement {
  ...
  public String toString() {
    return String.format(
        "DataElement [id=%s, description=%s, datatypeId=%s, minLength=%s, maxLength=%s, confLength=%s, tableId=%s, section=%s]",
        id, description, datatypeId, minLength, maxLength, confLength, tableId, section);
  }
}
