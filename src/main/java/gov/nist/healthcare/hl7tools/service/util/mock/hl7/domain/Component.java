...
public class Component {
  ...
  public String toString() {
    return String.format(
        "Component [id=%s, parentDatatypeId=%s, datatypeId=%s, position=%s, description=%s, usage=%s, minLength=%s, maxLength=%s, confLength=%s, tableId=%s]",
        id, parentDatatypeId, datatypeId, position, description, usage, minLength, maxLength,
        confLength, tableId);
  }
}
